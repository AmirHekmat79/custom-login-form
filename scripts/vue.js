...
new Vue({
    ...
    methods : {
      changeThemeHandler : function(){
        if(this.ThemeFlag){
          this.Icon[0].classList.remove('fa-moon');
          this.Icon[0].classList.add('fa-sun');
          this.Icon[0].style.color = "yellow";
          this.bodyElem.style.color = "#eee";
          this.Icon[0].style.transition = "all .4s";
          this.ThemeFlag = false;
         }else{
          this.Icon[0].classList.add('fa-moon');
          this.Icon[0].classList.remove('fa-sun');
          this.Icon[0].style.color = "#eee";
          this.bodyElem.style.color = "#232526";
          this.Icon[0].style.transition = "all .7s";
          this.ThemeFlag = true;
        }
      }
    }
  ...
  new Vue({
    ...
    data : {
      titleValue : "sign up" ,
      EmailInputExist : true
    }
    ,
    methods : {
      LoginHandler : function(event){
        event.preventDefault();
        this.titleValue = "sign in" ;
        this.EmailInputExist = false ;
      },
      registerHandler : function(event){
        event.preventDefault();
        this.titleValue = "sign up";
        this.EmailInputExist = true ;
      }
